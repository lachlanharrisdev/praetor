...
First off, thank you for considering contributing to Praetor. The open-source community is built on collaboration and it's people like you who contribute to the betterment of open-source security.

Following these guidelines helps to communicate that you respect the time of the developers managing and developing this open source project. In return, they should reciprocate that respect in addressing your issue, assessing changes, and helping you finalize your pull requests.

### Accepted Contributions

Most types of contributions are accepted and welcomed into Praetor, primarily as this is a non-affiliated project. We welcome anything from small improvements to documentation, writing tutorials or articles about our work, bug triaging and fixing, or any small-medium features. 
...
Praetor fills a very specific role, and as such many new features may either be unnecessary or need to be made in the right way to exist in the way it does. As such, it may be common for feature requests to be denied. If your request is denied, its most likely because it doesn't fully align with Praetor's vision.

Additionally, Praetor places strong emphasis on code quality and efficiency. If PRs or contributions are expected to be made exclusively with automated tooling or seem to have little care put into them, they may be denied. 

# Ground Rules

As a contributor to this repository, you must uphold key responsibilities. This ensures a safe space to collaborate and communicate with other contributors, and upholds the quality of Praetor.

**Responsibilities**
 * Ensure cross-device compatibility for every change that's accepted. While we currently only support linux, ensure changes aren't distro-specific
...
New to this repository or open source in general? Welcome to Praetor.

There are usually many [issues](https://github.com/lachlanharrisdev/praetor/issues), some smaller than others, which are open for anyone to fix. Issues aren't limited to "problems" in the code, but can also be feature improvements or general suggestions. 

When in doubt, it's best start with issues that are tagged with `status: backlog`. This means they have been acknowledged by a lead developer and are not being actively worked on. Click [here](https://github.com/lachlanharrisdev/praetor/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22status%3A%20backlog%22) to find these issues.
